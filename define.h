...
public:
  string name;
  StringList observers;
  StringList executors;

  string get_name() const
  {
    StringList::const_iterator it;

    string executors_str = "[";
    int index = 0;
    ...
    return name + executors_str + observers_str;
  };
  ...
  void print() const
  {
    ...
    // cout << "executors: " << executors << endl;
    cout << "number of executors: " << executors.size() << endl;
    for (it = executors.begin(); it != executors.end(); it++)
    {
      cout << "\t>>>> " << *it << endl;
    }
    cout << "number of observers: " << observers.size() << endl;
    for (it = observers.begin(); it != observers.end(); it++)
    {
      cout << "\t>>>> " << *it << endl;
    }
...
typedef vector<MyAction> Actions;
...
public:
  ...
  Literal ground_lit(const string &x, map<string, Fluent> ff_map) const
  {
    ...
    cout << "Check the fluent declaration." << endl
         << endl;
  ...
  Agent ground_agent(const string &x, map<string, Agent> a_map) const
  {
    ...
    cout << "Check the agent declaration." << endl
         << endl;
