...
public:
    ...
    KAction(const Planner* planner, const MyAction act, const PropositionType pt);
    ~KAction();
    
    /* get/set functions */
    string get_name() const;
    void set_name(const MyAction act);
    void set_type(const PropositionType);
    

    Planner get_planner() const;
    const Nodes* get_execs() const;
    const MyAction get_act() const;
