...
OBJS = bison.o lex.o main.o reader.o action.o planner.o kstate.o kedge.o kripke.o planninggraph.o event.o umodel.o
# OBJS = bison.o lex.o main.o reader.o
...
event.o: event.cpp event.h kedge.h define.h
	$(CC) $(CFLAGS) -c event.cpp -o event.o

umodel.o: umodel.cpp umodel.h event.h kedge.h define.h
	$(CC) $(CFLAGS) -c umodel.cpp -o umodel.o
...
clean:
	rm -f *.o *~ lex.c lex.yy.c bison.c tok.h lcp.tab.c lcp.tab.h lcp.output cpa+ built_date
