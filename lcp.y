...
%type <actions> action_decl
%type <actions> action_decls

%type <str_val> executor
%type <str_list> executors

%type <str_val> observer
%type <str_list> observers
...
action:
  id LEFT_BRAC executors RIGHT_BRAC {
    // $$ = new string(*$1 + "[" + *$3 + "]");
    $$ = new MyAction;
    $$->name = *$1;
    $$->executors = *$3;
  ...
  |
  id LEFT_BRAC executors RIGHT_BRAC LEFT_PAREN observers RIGHT_PAREN {
    // $$ = new string(*$1 + "[" + *$3 + "]" + "(" + *$6 + ")");
    $$ = new MyAction;
    $$->name = *$1;
    $$->observers = *$6;
